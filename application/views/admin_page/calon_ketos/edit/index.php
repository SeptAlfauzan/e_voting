    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            <div class="col-10 m-auto">
                <?= form_open_multipart('AdminPage/setEdit?id='.$calon->{'id_calon'}) ?>
                <div class="form-group">
                    <label for="exampleFormControlInput1">nama calon</label>
                    <input required type="text" name="nama_calon" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?= $calon->{'nama_calon'} ?>">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlFile1">Foto calon</label>
                    <div class="col-4 p-0">
                        <img src="<?= base_url() ?>images/<?= $calon->{'foto_calon'} ?>" alt="" srcset="" class="m-0 p-0" style="width: 200px; height: 280px; object-fit: cover;">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea required class="form-control" id="exampleFormControlTextarea1" name="visi_calon" rows="3"><?= $calon->{'visi_calon'} ?></textarea>
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Misi</label>
                    <textarea required class="form-control" id="exampleFormControlTextarea1" name="misi_calon" rows="3"><?= $calon->{'misi_calon'} ?></textarea>
                </div>
                <div class="form-group">
